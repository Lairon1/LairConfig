 ...
 * the License.
 */
package yaml.yaml.snakeyaml.env;

import java.util.Collection;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import yaml.yaml.snakeyaml.constructor.AbstractConstruct;
import yaml.yaml.snakeyaml.constructor.Constructor;
import yaml.yaml.snakeyaml.error.MissingEnvironmentVariableException;
